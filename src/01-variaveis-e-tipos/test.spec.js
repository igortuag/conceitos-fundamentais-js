...
import { calcularArea, calcularLitrosDeTinta, calcularNecessidadeTinta } from "./exercicio-06";

describe("Teste da função de saudação", () => {
...
describe("Teste da função converteNumeroParaMensagem", () => {
...
describe("Teste da função formatarDataNascimento", () => {
...
describe("Teste da função analisarValor", () => {
...
describe("Teste da função converterRealParaDolar", () => {
...
describe("Teste das funções de cálculo de tinta", () => {
  test('Deve calcular área corretamente', () => {
    const area = calcularArea(4, 2);
    expect(area).toBe(8);
  });

  test('Deve calcular litros de tinta necessários', () => {
    const litros = calcularLitrosDeTinta(8);
    expect(litros).toBe(4);
  });

  test('Deve retornar mensagem formatada com cálculos', () => {
    const resultado = calcularNecessidadeTinta(4, 2);
    expect(resultado).toBe("Para pintar uma parede de 8.00m², você precisará de 4.00L de tinta");
  });

  test('Deve rejeitar valores negativos', () => {
    const resultado = calcularNecessidadeTinta(-4, 2);
    expect(resultado).toBe("As dimensões precisam ser positivas");
  });
});
